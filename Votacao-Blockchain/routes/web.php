...
Route::middleware(['auth', 'Administrador', 'SenhaRedefinida'])->group(function () {
    ...
    Route::get('/nos', 'NosController@index')->name('telaCadastroNo');
    Route::post('/nos/novo', 'NosController@cadastrarNo')->name('cadastrarNo');
...
Route::middleware(['auth', 'SenhaRedefinida'])->group(function () {
    ...
    Route::post('/votacao/votar/{nome}', 'VotacaoController@votarCandidato')->name('votarCandidato');
